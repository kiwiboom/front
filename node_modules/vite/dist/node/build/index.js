...
async function build(options) {
    const { root = process.cwd(), base = '/', outDir = path_1.default.resolve(root, 'dist'), assetsDir = '_assets', assetsInlineLimit = 4096, assetsInclude, cssCodeSplit = true, alias = {}, resolvers = [], rollupInputOptions = {}, rollupOutputOptions = {}, emitIndex = true, emitAssets = true, write = true, minify = true, terserOptions = {}, esbuildTarget = 'es2020', enableEsbuild = true, silent = false, sourcemap = false, shouldPreload = null, env = {}, mode: configMode = 'production', define: userDefineReplacements = {}, cssPreprocessOptions, cssModuleOptions = {} } = options;
