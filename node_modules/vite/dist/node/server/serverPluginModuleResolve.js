...
exports.moduleResolvePlugin = ({ root, app, resolver }) => {
    ...
    app.use(async (ctx, next) => {
        ...
        if (importer) {
            const relativePath = path_1.default.relative(importer.replace(exports.moduleRE, ''), id);
            const filePath = path_1.default.join(importerFilePath, relativePath);
            const fileRealPath = resolver_1.resolveNodeModuleFile(root, filePath);
            if (fileRealPath) {
